...
enum class ErrorCode {
    ...
    // Tracker errors
    TRACKER_PARTICLE_NOT_FOUND = 450,
    TRACKER_PARTICLE_INACTIVE,
    TRACKER_DUPLICATE_ID,
    TRACKER_INDEX_COLLISION,
    TRACKER_REMAP_OUT_OF_RANGE,
    TRACKER_EMPTY_POOL,
    TRACKER_UNSATISFIABLE_CONSTRAINT,
    TRACKER_WEIGHT_MISMATCH,
    TRACKER_WEIGHT_FILE_INVALID,

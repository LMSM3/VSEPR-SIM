...
struct NuclearSpecies {
    ...
    // Ï_solid ~ molar_mass_g / Vm_solid; Vm_solid estimated from melting-point scaling
    ...
    double lindemann_ratio() const {
        if (T_debye_K <= 0.0 || melting_point_K <= 0.0 || molar_mass_g <= 0.0)
            return 0.0;
        // Vm ~ M/Ï_solid; Ï_solid crude from atomic_radius: Ï â‰ˆ M / (NA Â· (4/3)Ï€ rÂ³)
...
//          CRC Handbook (radius, Ï‡, EA, Ï_e), ENDF/B-VIII (Ïƒ_th),
...
inline constexpr NuclearSpecies NUCLEAR_SPECIES_DB[] = {
    ...
    { 2, 4,   "He", "Helium",     "He-4",  "gas",
      ...
      /* Ï_e */ 0.0,  /* Ïƒ_th */ 0.76,  /* Î”_keV */ 2424.916,  /* Sn */ 20577.6 },
    ...
    { 3, 7,   "Li", "Lithium",    "Li-7",  "bcc",
      ...
      /* Ï_e */ 92.8,   /* Ïƒ_th */ 70.5,   /* Î”_keV */ 14.908,   /* Sn */ 7250.6 },
    ...
    { 4, 9,   "Be", "Beryllium",  "Be-9",  "hcp",
      ...
      /* Ï_e */ 36.0,   /* Ïƒ_th */ 0.0076, /* Î”_keV */ 11348.7,  /* Sn */ 1664.8 },
    ...
    { 5, 11,  "B",  "Boron",      "B-11",  "rhombohedral",
      ...
      /* Ï_e */ 1e10,   /* Ïƒ_th */ 767.0,  /* Î”_keV */ 8668.1,   /* Sn */ 11454.2 },
    ...
    { 6, 12,  "C",  "Carbon",     "C-12",  "diamond-cubic",
      ...
      /* Ï_e */ 1e7,    /* Ïƒ_th */ 0.0035, /* Î”_keV */ 0.0,       /* Sn */ 18721.7 },
    ...
    { 7, 14,  "N",  "Nitrogen",   "N-14",  "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 1.91,   /* Î”_keV */ 2863.4,    /* Sn */ 10553.4 },
    ...
    { 8, 16,  "O",  "Oxygen",     "O-16",  "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.00028,/* Î”_keV */ -4737.0,   /* Sn */ 15664.0 },
    ...
    { 9, 19,  "F",  "Fluorine",   "F-19",  "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.0096, /* Î”_keV */ -1487.4,   /* Sn */ 10432.6 },
    ...
    {10, 20,  "Ne", "Neon",       "Ne-20", "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.039,  /* Î”_keV */ -7041.9,   /* Sn */ 16864.0 },
    ...
    {11, 23,  "Na", "Sodium",     "Na-23", "bcc",
      ...
      /* Ï_e */ 47.7,   /* Ïƒ_th */ 0.53,   /* Î”_keV */ -9529.8,   /* Sn */ 12418.9 },
    ...
    {12, 24,  "Mg", "Magnesium",  "Mg-24", "hcp",
      ...
      /* Ï_e */ 43.9,   /* Ïƒ_th */ 0.063,  /* Î”_keV */ -13933.6,  /* Sn */ 11693.0 },
    ...
    {13, 27,  "Al", "Aluminium",  "Al-27", "fcc",
      ...
      /* Ï_e */ 26.5,   /* Ïƒ_th */ 0.231,  /* Î”_keV */ -17196.7,  /* Sn */ 13058.0 },
    ...
    {14, 28,  "Si", "Silicon",    "Si-28", "diamond-cubic",
      ...
      /* Ï_e */ 640000.0,/* Ïƒ_th */ 0.171, /* Î”_keV */ -21492.9,  /* Sn */ 17179.0 },
    ...
    {15, 31,  "P",  "Phosphorus", "P-31",  "orthorhombic",
      ...
      /* Ï_e */ 1e11,  /* Ïƒ_th */ 0.172,  /* Î”_keV */ -24441.0,  /* Sn */ 12307.7 },
    ...
    {16, 32,  "S",  "Sulfur",     "S-32",  "orthorhombic",
      ...
      /* Ï_e */ 2e13,  /* Ïƒ_th */ 0.53,   /* Î”_keV */ -26014.8,  /* Sn */ 15043.5 },
    ...
    {17, 35,  "Cl", "Chlorine",   "Cl-35", "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 43.6,   /* Î”_keV */ -29013.6,  /* Sn */ 8579.5 },
    ...
    {18, 40,  "Ar", "Argon",      "Ar-40", "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.66,   /* Î”_keV */ -35039.9,  /* Sn */ 10601.4 },
    ...
    {19, 39,  "K",  "Potassium",  "K-39",  "bcc",
      ...
      /* Ï_e */ 72.0,  /* Ïƒ_th */ 2.1,    /* Î”_keV */ -33806.7,  /* Sn */ 13527.8 },
    ...
    {20, 40,  "Ca", "Calcium",    "Ca-40", "fcc",
      ...
      /* Ï_e */ 33.6,   /* Ïƒ_th */ 0.43,   /* Î”_keV */ -34846.5,  /* Sn */ 15643.1 },
    ...
    {21, 45,  "Sc", "Scandium",   "Sc-45", "hcp",
      ...
      /* Ï_e */ 562.0,  /* Ïƒ_th */ 27.2,   /* Î”_keV */ -41068.8,  /* Sn */ 11092.4 },
    ...
    {22, 48,  "Ti", "Titanium",   "Ti-48", "hcp",
      ...
      /* Ï_e */ 420.0,  /* Ïƒ_th */ 6.09,   /* Î”_keV */ -48490.0,  /* Sn */ 11628.0 },
    ...
    {23, 51,  "V",  "Vanadium",   "V-51",  "bcc",
      ...
      /* Ï_e */ 197.0,  /* Ïƒ_th */ 5.08,   /* Î”_keV */ -52200.0,  /* Sn */ 11050.0 },
    ...
    {24, 52,  "Cr", "Chromium",   "Cr-52", "bcc",
      ...
      /* Ï_e */ 125.0,  /* Ïƒ_th */ 3.07,   /* Î”_keV */ -55417.0,  /* Sn */ 12042.0 },
    ...
    {25, 55,  "Mn", "Manganese",  "Mn-55", "bcc-cubic",
      ...
      /* Ï_e */ 1440.0, /* Ïƒ_th */ 13.3,   /* Î”_keV */ -57710.0,  /* Sn */ 10235.0 },
    ...
    {26, 56,  "Fe", "Iron",       "Fe-56", "bcc",
      ...
      /* Ï_e */ 96.1,   /* Ïƒ_th */ 2.56,   /* Î”_keV */ -60606.4,  /* Sn */ 10844.0 },
    ...
    {27, 59,  "Co", "Cobalt",     "Co-59", "hcp",
      ...
      /* Ï_e */ 62.4,   /* Ïƒ_th */ 37.2,   /* Î”_keV */ -62228.0,  /* Sn */ 10459.0 },
    ...
    {28, 58,  "Ni", "Nickel",     "Ni-58", "fcc",
      ...
      /* Ï_e */ 69.3,   /* Ïƒ_th */ 4.49,   /* Î”_keV */ -60223.8,  /* Sn */ 12195.0 },
    ...
    {29, 63,  "Cu", "Copper",     "Cu-63", "fcc",
      ...
      /* Ï_e */ 16.8,   /* Ïƒ_th */ 3.78,   /* Î”_keV */ -65578.7,  /* Sn */ 10855.0 },
    ...
    {30, 64,  "Zn", "Zinc",       "Zn-64", "hcp",
      ...
      /* Ï_e */ 59.0,   /* Ïƒ_th */ 1.11,   /* Î”_keV */ -66000.0,  /* Sn */ 11864.0 },
    ...
    {31, 69,  "Ga", "Gallium",    "Ga-69", "orthorhombic",
      ...
      /* Ï_e */ 270.0,  /* Ïƒ_th */ 2.75,   /* Î”_keV */ -69327.0,  /* Sn */ 10852.0 },
    ...
    {32, 74,  "Ge", "Germanium",  "Ge-74", "diamond-cubic",
      ...
      /* Ï_e */ 460000.0,/* Ïƒ_th */ 2.20,  /* Î”_keV */ -73921.0,  /* Sn */ 10195.0 },
    ...
    {33, 75,  "As", "Arsenic",    "As-75", "rhombohedral",
      ...
      /* Ï_e */ 333.0,  /* Ïƒ_th */ 4.3,    /* Î”_keV */ -73033.0,  /* Sn */ 9882.0 },
    ...
    {34, 80,  "Se", "Selenium",   "Se-80", "trigonal",
      ...
      /* Ï_e */ 1e9,    /* Ïƒ_th */ 11.7,   /* Î”_keV */ -77760.0,  /* Sn */ 10498.0 },
    ...
    {35, 79,  "Br", "Bromine",    "Br-79", "liquid/orthorhombic",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 6.9,    /* Î”_keV */ -76068.0,  /* Sn */ 10152.0 },
    ...
    {36, 84,  "Kr", "Krypton",    "Kr-84", "gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 25.0,   /* Î”_keV */ -82524.0,  /* Sn */ 10757.0 },
    ...
    {37, 85,  "Rb", "Rubidium",   "Rb-85", "bcc",
      ...
      /* Ï_e */ 128.0, /* Ïƒ_th */ 0.38,   /* Î”_keV */ -82167.0,  /* Sn */ 9857.0 },
    ...
    {38, 88,  "Sr", "Strontium",  "Sr-88", "fcc",
      ...
      /* Ï_e */ 132.0, /* Ïƒ_th */ 1.28,   /* Î”_keV */ -87922.0,  /* Sn */ 11113.7 },
    ...
    {39, 89,  "Y",  "Yttrium",    "Y-89",  "hcp",
      ...
      /* Ï_e */ 596.0, /* Ïƒ_th */ 1.28,   /* Î”_keV */ -87709.0,  /* Sn */ 11490.5 },
    ...
    {40, 90,  "Zr", "Zirconium",  "Zr-90", "hcp",
      ...
      /* Ï_e */ 421.0, /* Ïƒ_th */ 0.185,  /* Î”_keV */ -88768.0,  /* Sn */ 11968.0 },
    ...
    {41, 93,  "Nb", "Niobium",    "Nb-93", "bcc",
      ...
      /* Ï_e */ 152.0, /* Ïƒ_th */ 1.15,   /* Î”_keV */ -87209.0,  /* Sn */ 7228.0 },
    ...
    {42, 98,  "Mo", "Molybdenum", "Mo-98", "bcc",
      ...
      /* Ï_e */ 53.4,  /* Ïƒ_th */ 2.60,   /* Î”_keV */ -88112.0,  /* Sn */ 9152.0 },
    ...
    {43, 97,  "Tc", "Technetium", "Tc-97", "hcp",
      ...
      /* Ï_e */ 200.0, /* Ïƒ_th */ 20.0,   /* Î”_keV */ -87220.0,  /* Sn */ 7011.0 },
    ...
    {44, 102, "Ru", "Ruthenium",  "Ru-102","hcp",
      ...
      /* Ï_e */ 71.0,  /* Ïƒ_th */ 2.56,   /* Î”_keV */ -91102.0,  /* Sn */ 9215.0 },
    ...
    {45, 103, "Rh", "Rhodium",    "Rh-103","fcc",
      ...
      /* Ï_e */ 43.3,  /* Ïƒ_th */ 145.0,  /* Î”_keV */ -88021.0,  /* Sn */ 9295.0 },
    ...
    {46, 108, "Pd", "Palladium",  "Pd-108","fcc",
      ...
      /* Ï_e */ 105.4, /* Ïƒ_th */ 7.0,    /* Î”_keV */ -89523.0,  /* Sn */ 9560.0 },
    ...
    {47, 107, "Ag", "Silver",     "Ag-107","fcc",
      ...
      /* Ï_e */ 15.9,  /* Ïƒ_th */ 63.3,   /* Î”_keV */ -88404.0,  /* Sn */ 9545.0 },
    ...
    {48, 114, "Cd", "Cadmium",    "Cd-114","hcp",
      ...
      /* Ï_e */ 72.7,  /* Ïƒ_th */ 2500.0, /* Î”_keV */ -90021.0,  /* Sn */ 9044.0 },
    ...
    {49, 115, "In", "Indium",     "In-115","tetragonal",
      ...
      /* Ï_e */ 83.7,  /* Ïƒ_th */ 194.0,  /* Î”_keV */ -89538.0,  /* Sn */ 9234.0 },
    ...
    {50, 120, "Sn", "Tin",        "Sn-120","tetragonal",
      ...
      /* Ï_e */ 115.0, /* Ïƒ_th */ 0.626,  /* Î”_keV */ -91102.0,  /* Sn */ 9105.0 },
    ...
    {51, 121, "Sb", "Antimony",   "Sb-121","rhombohedral",
      ...
      /* Ï_e */ 417.0, /* Ïƒ_th */ 5.91,   /* Î”_keV */ -89200.0,  /* Sn */ 9574.0 },
    ...
    {52, 130, "Te", "Tellurium",  "Te-130","trigonal",
      ...
      /* Ï_e */ 4.36e8,/* Ïƒ_th */ 4.23,   /* Î”_keV */ -87352.0,  /* Sn */ 9020.0 },
    ...
    {53, 127, "I",  "Iodine",     "I-127", "orthorhombic",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 6.2,    /* Î”_keV */ -88984.0,  /* Sn */ 9133.4 },
    ...
    {54, 132, "Xe", "Xenon",      "Xe-132","gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 23.9,   /* Î”_keV */ -87659.0,  /* Sn */ 10624.6 },
    ...
    {55, 133, "Cs", "Caesium",    "Cs-133","bcc",
      ...
      /* Ï_e */ 205.0, /* Ïƒ_th */ 29.0,   /* Î”_keV */ -88071.0,  /* Sn */ 9378.5 },
    ...
    {56, 138, "Ba", "Barium",     "Ba-138","bcc",
      ...
      /* Ï_e */ 332.0, /* Ïƒ_th */ 1.20,   /* Î”_keV */ -88263.0,  /* Sn */ 8604.8 },
    ...
    {57, 139, "La", "Lanthanum",  "La-139","dhcp",
      ...
      /* Ï_e */ 615.0, /* Ïƒ_th */ 8.97,   /* Î”_keV */ -87232.0,  /* Sn */ 8785.0 },
    ...
    {58, 140, "Ce", "Cerium",     "Ce-140","fcc",
      ...
      /* Ï_e */ 828.0, /* Ïƒ_th */ 0.57,   /* Î”_keV */ -88083.0,  /* Sn */ 9068.7 },
    ...
    {59, 141, "Pr", "Praseodymium","Pr-141","dhcp",
      ...
      /* Ï_e */ 700.0, /* Ïƒ_th */ 11.5,   /* Î”_keV */ -86020.0,  /* Sn */ 9448.0 },
    ...
    {60, 142, "Nd", "Neodymium",  "Nd-142","dhcp",
      ...
      /* Ï_e */ 643.0, /* Ïƒ_th */ 49.0,   /* Î”_keV */ -85960.0,  /* Sn */ 9044.0 },
    ...
    {61, 145, "Pm", "Promethium", "Pm-145","dhcp",
      ...
      /* Ï_e */ 750.0, /* Ïƒ_th */ 168.4,  /* Î”_keV */ -84540.0,  /* Sn */ 8884.0 },
    ...
    {62, 152, "Sm", "Samarium",   "Sm-152","rhombohedral",
      ...
      /* Ï_e */ 940.0, /* Ïƒ_th */ 5922.0, /* Î”_keV */ -86321.0,  /* Sn */ 8259.5 },
    ...
    {63, 153, "Eu", "Europium",   "Eu-153","bcc",
      ...
      /* Ï_e */ 900.0, /* Ïƒ_th */ 9200.0, /* Î”_keV */ -85970.0,  /* Sn */ 8474.5 },
    ...
    {64, 158, "Gd", "Gadolinium", "Gd-158","hcp",
      ...
      /* Ï_e */ 1310.0,/* Ïƒ_th */ 49700.0,/* Î”_keV */ -87998.0,  /* Sn */ 8536.4 },
    ...
    {65, 159, "Tb", "Terbium",    "Tb-159","hcp",
      ...
      /* Ï_e */ 1150.0,/* Ïƒ_th */ 23.4,   /* Î”_keV */ -84604.0,  /* Sn */ 8635.5 },
    ...
    {66, 164, "Dy", "Dysprosium", "Dy-164","hcp",
      ...
      /* Ï_e */ 926.0, /* Ïƒ_th */ 920.0,  /* Î”_keV */ -86359.0,  /* Sn */ 7658.2 },
    ...
    {67, 165, "Ho", "Holmium",    "Ho-165","hcp",
      ...
      /* Ï_e */ 814.0, /* Ïƒ_th */ 64.7,   /* Î”_keV */ -84904.0,  /* Sn */ 7975.8 },
    ...
    {68, 166, "Er", "Erbium",     "Er-166","hcp",
      ...
      /* Ï_e */ 860.0, /* Ïƒ_th */ 159.0,  /* Î”_keV */ -85699.0,  /* Sn */ 8481.0 },
    ...
    {69, 169, "Tm", "Thulium",    "Tm-169","hcp",
      ...
      /* Ï_e */ 676.0, /* Ïƒ_th */ 100.0,  /* Î”_keV */ -83281.0,  /* Sn */ 8020.3 },
    ...
    {70, 174, "Yb", "Ytterbium",  "Yb-174","fcc",
      ...
      /* Ï_e */ 250.0, /* Ïƒ_th */ 34.8,   /* Î”_keV */ -84254.0,  /* Sn */ 8483.0 },
    ...
    {71, 175, "Lu", "Lutetium",   "Lu-175","hcp",
      ...
      /* Ï_e */ 582.0, /* Ïƒ_th */ 74.0,   /* Î”_keV */ -83275.0,  /* Sn */ 8218.1 },
    ...
    {72, 180, "Hf", "Hafnium",    "Hf-180","hcp",
      ...
      /* Ï_e */ 331.0, /* Ïƒ_th */ 104.0,  /* Î”_keV */ -85619.0,  /* Sn */ 7621.9 },
    ...
    {73, 181, "Ta", "Tantalum",   "Ta-181","bcc",
      ...
      /* Ï_e */ 131.0, /* Ïƒ_th */ 20.6,   /* Î”_keV */ -84010.0,  /* Sn */ 7585.0 },
    ...
    {74, 184, "W",  "Tungsten",   "W-184", "bcc",
      ...
      /* Ï_e */ 52.8,  /* Ïƒ_th */ 18.3,   /* Î”_keV */ -85752.0,  /* Sn */ 7411.7 },
    ...
    {75, 187, "Re", "Rhenium",    "Re-187","hcp",
      ...
      /* Ï_e */ 193.0, /* Ïƒ_th */ 89.7,   /* Î”_keV */ -85515.0,  /* Sn */ 7364.9 },
    ...
    {76, 192, "Os", "Osmium",     "Os-192","hcp",
      ...
      /* Ï_e */ 81.2,  /* Ïƒ_th */ 16.0,   /* Î”_keV */ -85820.0,  /* Sn */ 7791.6 },
    ...
    {77, 193, "Ir", "Iridium",    "Ir-193","fcc",
      ...
      /* Ï_e */ 47.1,  /* Ïƒ_th */ 425.0,  /* Î”_keV */ -84560.0,  /* Sn */ 7390.3 },
    ...
    {78, 195, "Pt", "Platinum",   "Pt-195","fcc",
      ...
      /* Ï_e */ 105.0, /* Ïƒ_th */ 10.3,   /* Î”_keV */ -86017.0,  /* Sn */ 7922.0 },
    ...
    {79, 197, "Au", "Gold",       "Au-197","fcc",
      ...
      /* Ï_e */ 22.1,  /* Ïƒ_th */ 98.7,   /* Î”_keV */ -87011.0,  /* Sn */ 8071.5 },
    ...
    {80, 202, "Hg", "Mercury",    "Hg-202","rhombohedral",
      ...
      /* Ï_e */ 958.0, /* Ïƒ_th */ 374.0,  /* Î”_keV */ -85393.0,  /* Sn */ 7455.7 },
    ...
    {81, 205, "Tl", "Thallium",   "Tl-205","hcp",
      ...
      /* Ï_e */ 180.0, /* Ïƒ_th */ 3.43,   /* Î”_keV */ -87444.0,  /* Sn */ 7391.0 },
    ...
    {82, 208, "Pb", "Lead",       "Pb-208","fcc",
      ...
      /* Ï_e */ 208.0, /* Ïƒ_th */ 0.171,  /* Î”_keV */ -87567.0,  /* Sn */ 7367.6 },
    ...
    {83, 209, "Bi", "Bismuth",    "Bi-209","rhombohedral",
      ...
      /* Ï_e */ 1290.0,/* Ïƒ_th */ 0.034,  /* Î”_keV */ -83461.0,  /* Sn */ 7460.5 },
    ...
    {84, 209, "Po", "Polonium",   "Po-209","simple-cubic",
      ...
      /* Ï_e */ 400.0, /* Ïƒ_th */ 0.5,    /* Î”_keV */ -81521.0,  /* Sn */ 8118.0 },
    ...
    {85, 210, "At", "Astatine",   "At-210","unknown",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.0,    /* Î”_keV */ -78220.0,  /* Sn */ 8360.0 },
    ...
    {86, 222, "Rn", "Radon",      "Rn-222","gas",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.70,   /* Î”_keV */ -76193.0,  /* Sn */ 8175.0 },
    ...
    {87, 223, "Fr", "Francium",   "Fr-223","bcc",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.0,    /* Î”_keV */ -72940.0,  /* Sn */ 8280.0 },
    ...
    {88, 226, "Ra", "Radium",     "Ra-226","bcc",
      ...
      /* Ï_e */ 1000.0,/* Ïƒ_th */ 12.8,   /* Î”_keV */ -71169.0,  /* Sn */ 9358.2 },
    ...
    {89, 227, "Ac", "Actinium",   "Ac-227","fcc",
      ...
      /* Ï_e */ 1000.0,/* Ïƒ_th */ 880.0,  /* Î”_keV */ -69378.0,  /* Sn */ 9003.3 },
    ...
    {90, 232, "Th", "Thorium",    "Th-232","fcc",
      ...
      /* Ï_e */ 147.0, /* Ïƒ_th */ 7.37,   /* Î”_keV */ -35445.6,  /* Sn */ 8853.0 },
    ...
    {91, 231, "Pa", "Protactinium","Pa-231","bct",
      ...
      /* Ï_e */ 177.0, /* Ïƒ_th */ 200.6,  /* Î”_keV */ -36197.0,  /* Sn */ 8440.0 },
    ...
    {92, 238, "U",  "Uranium",    "U-238", "orthorhombic-alpha",
      ...
      /* Ï_e */ 280.0, /* Ïƒ_th */ 7.57,   /* Î”_keV */ 47309.0,   /* Sn */ 5298.4 },
    ...
    {93, 237, "Np", "Neptunium",  "Np-237","orthorhombic",
      ...
      /* Ï_e */ 1220.0,/* Ïƒ_th */ 175.9,  /* Î”_keV */ 44874.0,   /* Sn */ 5489.6 },
    ...
    {94, 239, "Pu", "Plutonium",  "Pu-239","monoclinic-alpha",
      ...
      /* Ï_e */ 1460.0,/* Ïƒ_th */ 1017.3, /* Î”_keV */ 48590.0,   /* Sn */ 5645.6 },
    ...
    {95, 243, "Am", "Americium",  "Am-243","dhcp",
      ...
      /* Ï_e */ 680.0, /* Ïƒ_th */ 75.3,   /* Î”_keV */ 55460.0,   /* Sn */ 5362.5 },
    ...
    {96, 247, "Cm", "Curium",     "Cm-247","dhcp",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 60.0,   /* Î”_keV */ 67395.0,   /* Sn */ 5330.0 },
    ...
    {97, 247, "Bk", "Berkelium",  "Bk-247","dhcp",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 710.0,  /* Î”_keV */ 73990.0,   /* Sn */ 5170.0 },
    ...
    {98, 252, "Cf", "Californium","Cf-252","dhcp",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 2900.0, /* Î”_keV */ 82620.0,   /* Sn */ 4809.0 },
    ...
    {99, 252, "Es", "Einsteinium","Es-252","fcc",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 160.0,  /* Î”_keV */ 93560.0,   /* Sn */ 4780.0 },
    ...
    {100,257, "Fm", "Fermium",    "Fm-257","unknown",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 33.0,   /* Î”_keV */ 99890.0,   /* Sn */ 4720.0 },
    ...
    {101,258, "Md", "Mendelevium","Md-258","unknown",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.0,    /* Î”_keV */ 107930.0,  /* Sn */ 4660.0 },
    ...
    {102,259, "No", "Nobelium",   "No-259","unknown",
      ...
      /* Ï_e */ 0.0,   /* Ïƒ_th */ 0.0,    /* Î”_keV */ 115010.0,  /* Sn */ 4600.0 },
};

...
\fancyhead[R]{\small\textit{Condensed Reference (v3.0.0)}}
\fancyfoot[C]{\thepage}
...
{\normalsize Version 3.0.0 --- January 2025}\\[0.3em]
...
Extension points (quantum corrections, reactive potentials, ML surrogates) are architecturally reserved but not implemented in v3.0.0.
...
Coarse-Grained & 10k+ & CG placeholder \\
\bottomrule
\end{tabular}
\end{center}

...
%
%  This document compiles all 43 section documents into a unified,
...
% ── SM-Channel Identity Layer ─────────────────────────────────────────────
\chapter{SM-Channel Identity Layer}
\label{ch:smidentity}
\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},
  addtotoc={1,section,1,{SM-Channel Identity Layer},sec:smidentity-start}
]{section_sm_identity_layer.pdf}

% ── IKK Theory → VSIM Kernel Bridge ──────────────────────────────────────
\chapter{IKK Theory to VSIM Kernel Bridge}
\label{ch:ikkbridge}
\includepdf[pages=-,pagecommand={\thispagestyle{fancy}},
  addtotoc={1,section,1,{IKK Theory to VSIM Kernel Bridge},sec:ikkbridge-start}
]{section_ikk_kernel_bridge.pdf}
...
\textbf{Date:} \today\\
\textbf{Documents:} 43 LaTeX source files\\

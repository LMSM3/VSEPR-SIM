...
\begin{itemize}
\item \textbf{Heat normalization and gating:} Interface designed, ready for
      integration.
\item \textbf{Bond scoring with heat bias:} Equations defined; requires
      coupling to the reaction template structure in \S8.
\item \textbf{Amino acid reference table:} Complete (20 entries).

"""Write continuous_run_display.hpp with fully inline console path."""
import pathlib
...
private:
    // Defined in continuous_run_display.cpp for GL builds.
    void run_gl_loop();
...
dest = pathlib.Path("C:/R/VSPER-SIM/src/vis/continuous_run_display.hpp")
dest.write_text(content, encoding="utf-8")
print(f"written {len(content.splitlines())} lines -> {dest}")
